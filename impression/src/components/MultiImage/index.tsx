...
function MultiImage(props: { imageLink: string, prompt: string, apiKey: string }) {
    ...
    return (
        <div className="MultiImageMultiImage">
            <p className="MultiImageText">Identify the original image (Images will load in a few seconds)!</p>
            <Stack direction="row" justifyContent="center"
                alignItems="center" spacing={2}>
                <Image imageLink={images[0]} correctImage={correctImageNum == 0} />
                <Image imageLink={images[1]} correctImage={correctImageNum == 1} />
                <Image imageLink={images[2]} correctImage={correctImageNum == 2} />
                <Image imageLink={images[3]} correctImage={correctImageNum == 3} />
                <Image imageLink={images[4]} correctImage={correctImageNum == 4} />
            </Stack>
